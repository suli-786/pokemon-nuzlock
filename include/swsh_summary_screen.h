...
// The master toggle SWSH_SUMMARY_SCREEN lives in include/config/swsh_ui.h to
...
// Overhaul: derived from the standard expansion config instead of being a second,
// independent switch for the same feature -- otherwise flipping
// P_SUMMARY_SCREEN_IV_EV_INFO in include/config/summary_screen.h would silently do
// nothing while this screen is active. Upstream had this hardcoded TRUE.
#define SWSH_SUMMARY_SHOW_IV_EV                       P_SUMMARY_SCREEN_IV_EV_INFO // A on the skills page cycles Stats -> IVs -> EVs
