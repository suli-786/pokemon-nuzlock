...
// Overhaul (docs/overhaul/REGISTRY.md): single-player project — link/e-reader/event
// data freed for feature storage. FREE_MATCH_CALL TRUE (owner: no rematches);
// FREE_TRAINER_HILL/TOWER stay FALSE (playable facilities). Save layout freezes at run start.
// SaveBlock1 configs
