...
#define OW_FLAG_NO_TRAINER_SEE      FLAG_OVERHAUL_NO_TRAINER_SEE // If this flag is set, trainers will not battle the player unless they're talked to.
...
#define OW_POPUP_GENERATION        GEN_8    // Different generations display location names in overworld pop-ups differently.
                                            // Choices are GEN_3, GEN_5 and GEN_8 (SwSh, ported from Montblanc). All others default to Gen3 pop-ups.
