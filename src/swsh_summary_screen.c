...
static bool8 ExtractMonDataToSummaryStruct(struct Pokemon *mon)
{
    ...
    case 3:
        ...
        break;
    case 4:
        // Overhaul: routed through GetAdjustedIvData (src/pokemon_summary_screen.c)
        // instead of reading MON_DATA_*_IV raw, so P_SUMMARY_SCREEN_IV_HYPERTRAIN is
        // honoured here exactly as it is on the vanilla screen -- a hyper-trained stat
        // reads 31. GetAdjustedIvData is a no-op when that config is FALSE.
