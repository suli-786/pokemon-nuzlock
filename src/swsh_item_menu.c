#include "global.h"
// Explicit, never by include order: without this the SWSH_ITEM_MENU_* tuning
// knobs would evaluate to 0 and half this file would vanish with a green build.
// See docs/overhaul/UI_PORT_CHECKLIST.md §1.
