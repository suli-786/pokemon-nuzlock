...
// NOTE (overhaul): under SWSH_ITEM_MENU_PYRAMID this whole file is compiled out
// -- the SwSh bag draws the pyramid bag too. See docs/overhaul/UI_PORT_CHECKLIST.md §3.5.
