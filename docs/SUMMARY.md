...
- [Overhaul (this fork)]()
    - [Roadmap](overhaul/ROADMAP.md)
    - [Registry: flags, save space, credits](overhaul/REGISTRY.md)
    - [Route to gym claim table](overhaul/GYM_CLAIMS.md)
    - [Randolocke source-build reference](overhaul/RANDOLOCKE_REFERENCE.md)
    - [Investigations]()
        - [Architecture](overhaul/investigations/ws_architecture.md)
        - [Story cuts](overhaul/investigations/ws_story-cuts.md)
        - [Dialog speed](overhaul/investigations/ws_dialog-speed.md)
        - [Encounter toggles](overhaul/investigations/ws_encounter-toggles.md)
        - [Nuzlocke core](overhaul/investigations/ws_nuzlocke-core.md)
        - [Nuzlocke tracker](overhaul/investigations/ws_nuzlocke-tracker.md)
        - [Knowledge system](overhaul/investigations/ws_knowledge-system.md)
        - [AI quality](overhaul/investigations/ws_ai-quality.md)
        - [VGC doubles gyms](overhaul/investigations/ws_vgc-doubles-gyms.md)
        - [Randomizer fairness](overhaul/investigations/ws_randomizer-fairness.md)
        - [UI modernization](overhaul/investigations/ws_ui-modernization.md)
        - [Sprites and visuals](overhaul/investigations/ws_sprites-visuals.md)
        - [Quiz NPCs](overhaul/investigations/ws_quiz-npcs.md)
